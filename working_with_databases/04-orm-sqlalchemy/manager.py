...
# It always shall have DeclarativeBase class
...
class Portfolio(Base):
    ...
    """
    if you don't use back_populates, sqlalchemy won't know to connect the relationships, 
